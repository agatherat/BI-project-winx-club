...
public class PrestashopTestset extends TestBase {
    ...
    public void test_downloadInvoice() throws InterruptedException {
        ...
        pagePrestashop.inputTextField_byId("email", "hania.gibus@gmail.com");
        pagePrestashop.inputTextField_byId("passwd", "winxclub");
        pagePrestashop.clickOn_byId("submit_login");

        pagePrestashop.waitForElement_byXpath("//*[@id=\"subtab-AdminParentOrders\"]/a");
        ...
        pagePrestashop.waitForElement_byXpath("//*[@id=\"order_grid_table\"]/tbody/tr[1]/td[9]/div/button");
        ...
        pagePrestashop.openPage();
        pagePrestashop.waitForElement_byXpath("//*[@id=\"footer_account_list\"]/li[2]/a");
        pagePrestashop.clickOn_byXpath("//*[@id=\"footer_account_list\"]/li[2]/a"); //click on orders link
